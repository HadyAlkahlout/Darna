...
import com.raiyansoft.darnaapp.databinding.FragmentDeliveryOrdersBinding
import com.raiyansoft.darnaapp.ui.viewmodel.DeliveryOrdersViewModel
import com.raiyansoft.darnaapp.uitl.OnScrollListener

class DeliveryOrdersFragment : Fragment(), OrderAdapter.OrderClick {

    private lateinit var binding: FragmentDeliveryOrdersBinding
    ...
    override fun orderClick(id: Int, status: Int) {
        ...
        findNavController().navigate(
            R.id.action_deliveryOrdersFragment_to_deliveryOrderFragment,
            bundle
        )
    }
